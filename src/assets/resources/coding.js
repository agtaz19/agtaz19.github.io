        ...
        [
            group("Just Starting Out", [
                group("Core Concepts", [
                    leaf(
                        ...
                        "Arguably the cheapest and most formal broad introduction to programming, abstraction, memory, algorithms, and systems thinking.",
                    ),
                    leaf(
                    ...
                    leaf(
                        ...
                        [
                            ...
                            [
                                "Algorithms, Part 1 - Elementary Data Structures, Sorting, Searching Algorithms",
                ...
                group("Theory & Reference", [
                    ...
                    leaf(
                        ...
                        "Interactive explanations of trees, graphs, heaps, and hash tables.",
                    ),
                ]),
            ]),
            group("Best Practices", [
                group("Code Quality & Design", [
                    leaf(
                        "Clean Code (Robert C. Martin), Github Summary with Links to Book & Resources",
            ...
            group("Tooling, Workflow, & Environment", [
                ...
                group("Development Environments", [
                    leaf(
                        ...
                        "Debugging, extensions, and language servers. VS Code is great with a ton of support, ultimately use the environment that works best for you: Anaconda, JetBrains, and Google Colab is alright as well.",
                    ),
                    leaf(
        ...
        [
            group("Learning & Practice", [
                ...
                leaf("SQL Murder Mystery.", "https://mystery.knightlab.com/", [
                    "Using what you learn for fun, additionally see",
