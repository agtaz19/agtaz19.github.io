    ...
    return (
        <Link to="/" className="flex items-center" aria-label="Home">
            <svg width="44" height="36" viewBox="0 0 44 36" fill="none" xmlns="http://www.w3.org/2000/svg"
                ...
                <rect x="2" y="2" width="18" height="32" rx="2" fill={onDarkBg ? "white" : "#111111"} />
                <rect x="12" y="8" width="30" height="20" rx="2" fill={transparent ? "rgba(255,255,255,0.35)" : "rgb(212,175,55)"} />
                <rect x="14" y="10" width="26" height="16" rx="1" fill={onDarkBg ? "white" : "#111111"} opacity="0.15" />
                <line x1="2" y1="34" x2="20" y2="34" stroke={transparent ? "white" : "rgb(212,175,55)"} strokeWidth="2" strokeLinecap="round" />
            </svg>
        </Link>
    );
}
