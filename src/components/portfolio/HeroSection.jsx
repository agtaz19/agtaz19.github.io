 ...
 *
 * - Animated GIF background with dark overlay
...
// ── Hero background — professional still image ──
const HERO_IMAGE = "https://images.unsplash.com/photo-1486325212027-8081e485255e?w=1800&q=80&fit=crop";
...
export default function HeroSection() {
    ...
    return (
        <section className="relative w-full h-screen min-h-[600px] flex items-end overflow-hidden">
            ...
            <div
                className="relative z-10 pb-16 md:pb-24 w-full max-w-5xl"
            ...
            >
                ...
                {/* Subtitle */}
                <p
                    className="mt-5 text-white/75 text-base md:text-lg leading-relaxed max-w-2xl"
                    style={{ fontFamily: "var(--font-body)" }}
                >
                    Finance, consulting, and quantitative strategy at the highest level.
                    Precision-driven solutions for complex markets and executive decisions.
                </p>
                ...
                <div className="flex items-center gap-0 mt-8 md:mt-10">
                    <a
                        ...
                        className="inline-flex items-center gap-2.5 px-6 py-3 text-sm font-semibold tracking-[0.1em] uppercase
