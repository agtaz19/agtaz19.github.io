...
import heroMoon from "@/assets/stock_photos/Blog_Post_Moon.jpg";
import { POSTS, TAG_COLORS } from "./Blog";
        ...
        <>
            ...
            <section className="relative bg-dark-panel border-b overflow-hidden" style={{ borderColor: "rgba(255,255,255,0.08)" }}>
                <div className="absolute inset-0">
                    <img src={heroMoon} alt="" className="w-full h-full object-cover object-center opacity-40" />
                ...
                <div className="relative z-10" style={{ paddingTop: "clamp(5rem,10vw,9rem)", paddingBottom: "clamp(3rem,6vw,5rem)", paddingLeft: "var(--fluid-pad)", paddingRight: "var(--fluid-pad)" }}>
                    ...
                    <h1 className="font-heading font-bold text-white leading-[1.08]" style={{ fontSize: "clamp(2.2rem,5vw,4.5rem)" }}>{post.title}</h1>
                    <p className="mt-5 text-base md:text-lg leading-relaxed text-white/60">{post.summary}</p>
                </div>
            </section>
